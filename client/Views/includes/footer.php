<footer class="bg-white lg:grid lg:grid-cols-5">
    ...
    <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
                <p>
                    <span class="text-xs uppercase tracking-wide text-gray-500"> HotLine </span>
                ...
                <ul class="mt-8 flex gap-6">
                    <li>
                        <a href="https://www.facebook.com/anhnhph33991" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
                    ...
                    <li>
                        <a href="https://github.com/luxchill?tab=repositories" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
