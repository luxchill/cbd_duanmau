<div class="w-full h-screen flex justify-center items-center">
    <div class="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="flex justify-center mx-auto">
            <h1 class="w-1/3 font-medium text-center text-gray-500 capitalize dark:border-gray-400 dark:text-gray-300">Register</h1>
        </div>

        <form class="mt-6" action="?act=handleRegister" method="post">
            <div>
                <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">Username</label>
                <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" name="username" />
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Bạn đã có tài khoản? <a href="?act=login" class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Login</a></p>
    </div>
</div>